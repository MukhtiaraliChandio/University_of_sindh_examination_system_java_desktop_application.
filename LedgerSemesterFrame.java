...
public class LedgerSemesterFrame extends javax.swing.JFrame {
    ...
    private void getSchemeSemester(){
            /////***** getScheme By Program ID & Batch Year *****/////
            ProgramBean progBeans = (ProgramBean)(JComboProgId.getSelectedItem());
            if(progBeans == null) return;

            BatchBean batchBeans = (BatchBean)(JComboBatchYear.getSelectedItem());
            if(batchBeans == null) return;

            SchemeBean schemeBeans = null;
            try{
                    schemeBeans = DatabaseManager.getScheme(progBeans.getProgId(), batchBeans.getBatchYear());
                    if(schemeBeans == null) return;

            }catch(Exception ee){
                    ee.printStackTrace();
                    MainWorkPlace.Jpane(" Getting Scheme By Program & Batch in Get Scheme Semester "+ee);
            }
            /////***** getScheme By Program ID & Batch Year *****/////


            /////***** getSchemeSemester By Scheme ID & Part *****/////
            PartBean partBeans = (PartBean)(JComboParts.getSelectedItem());
            if(partBeans == null) return;

            Vector schemeSemesterVector = null;
            try{
                    schemeSemesterVector = DatabaseManager.getSchemeSemester(partBeans.getPartId(), schemeBeans.getSchemeId());

                    for(int i = 0; i < schemeSemesterVector.size(); i++){
                            JComboSchemeSemester.addItem(schemeSemesterVector.elementAt(i));
                    }

            }catch(Exception ee){
                    ee.printStackTrace();
                    MainWorkPlace.Jpane(" Getting Scheme Semester By Scheme & Parts in Get Scheme Semester "+ee);
            }
            /////***** getSchemeSemester By Scheme ID & Part*****/////
    ...
    /////***** getLedgerSemester Load *****/////
    private void getLedgerSemester(){
            ...
            SchemeSemesterBean ssbeans = (SchemeSemesterBean)(JComboSchemeSemester.getSelectedItem());
            if(ssbeans == null)return;

            try{
                    Vector v = DatabaseManager.getLedgerSemester(slbeans.getSeatListId(), ssbeans.getSemester());
                    jList.setListData(v);
            }catch(Exception ee){
                    ee.printStackTrace();
                    MainWorkPlace.Jpane(" getting Ledger Semester Error "+ee);
            }
    }
    ...
    private void paste(){
            ...
            try{
                    Vector v = DatabaseManager.getLedgerListDetails();
                    int rows = 0;

                    for(int i = 0; i < v.size(); i++){
                            LedgerListDetailBean llbeans = (LedgerListDetailBean)v.elementAt(i);
                            if(llbeans == null) continue;
                            try{
                                    rows += DatabaseManager.addLedgerSemester(llbeans.getSeatListId(), llbeans.getStuRollNo(), ssbeans.getSemester(), "");
                            }catch(Exception ee){
                                    ee.printStackTrace();
                    ...
                    ex.printStackTrace();
                    MainWorkPlace.Jpane(" Pasting Error "+ex);
            }
            getLedgerSemester();
    ...
    private void update(){
            ...
            try{
                    for(int i = 0; i < ob.length; i++){
                            LedgerSemesterBean beans = (LedgerSemesterBean)(ob[i]);
                            rows += DatabaseManager.updateLedgerSemester(beans.getSeatListId(), beans.getStuRollNo(), beans.getSemester(), remarks);
                    }
    ...
    private void delete(){
            ...
            try{
                    for(int i = 0; i < ob.length; i++){
                            LedgerSemesterBean beans = (LedgerSemesterBean)(ob[i]);
                            rows += DatabaseManager.deleteLedgerSemester(beans.getSeatListId(), beans.getStuRollNo(), beans.getSemester());
                    }
    ...
    private void initComponents() {
        ...
        JComboSchemeSemester = new javax.swing.JComboBox();
        ...
        jLabel1.setText("Ledger Semester");
        ...
        JComboSchemeSemester.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
        JComboSchemeSemester.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JComboSchemeSemesterActionPerformed(evt);
            }
        });
        ...
        Tsemester.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(368, 368, 368)
                                .addComponent(hint, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(JComboSchemeSemester, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(3, 3, 3)
                                .addComponent(jLabel17))
                            .addComponent(JComboSchemeSemester, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(paste, javax.swing.GroupLayout.DEFAULT_SIZE, 229, Short.MAX_VALUE)
                        .addContainerGap())))
        );
    ...
    private void jListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jListValueChanged
        LedgerSemesterBean beans = (LedgerSemesterBean)(jList.getSelectedValue());
        if(beans == null) return;

        TseatListId.setText(""+beans.getSeatListId());
        Trollno.setText(""+beans.getStuRollNo());
        Tsemester.setText(""+beans.getSemester());
    ...
    private void JComboSchemeSemesterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JComboSchemeSemesterActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JComboSchemeSemesterActionPerformed
    ...
    private javax.swing.JComboBox JComboSchemeSemester;

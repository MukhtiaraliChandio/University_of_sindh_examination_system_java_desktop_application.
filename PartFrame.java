...
public class PartFrame extends javax.swing.JFrame {
    ...
    public PartFrame() {
        ...
        TbatchShift.setEnabled(false);
        TbatchGroup.setEnabled(false);
    ...
    private void add(){
        try{
            ...
            int partId = Integer.parseInt(JComboParts.getSelectedItem().toString());
            int partYear = Integer.parseInt(TpartYear.getText());
            
            BatchBean beans = (BatchBean)(JComboBatchYear.getSelectedItem());
            if(beans == null)return;
            int batchId = beans.getBatchId();

            byte row = (byte)(DatabaseManager.addPart(partId, batchId, partYear, remarks));
    ...
    private void update(){
        try{
            ...
            byte row = (byte)(DatabaseManager.updatePart(partId, batchId, partYear, remarks));
            MainWorkPlace.queryResult(row, "Inserted");
            clear();
            getPart();
        }catch(Exception ee){
    ...
    private void delete(){
        ...
        try{
            ...
            byte row = (byte)(DatabaseManager.deletePart(partId, batchId));	
            MainWorkPlace.queryResult(row, "Deleted");
            clear();
            getPart();
        }catch(Exception ee){
            ee.printStackTrace();
            MainWorkPlace.Jpane("This Part has some Seat List "+ee.getMessage());
        }
    }
    ...
    private void clear(){
            ...
            JComboParts.setSelectedIndex(0);
            TpartYear.setText("");
            remarksArea.setText("");
    }
    ...
    private void initComponents() {
        ...
        TpartYear = new javax.swing.JTextField();
        ...
        TpartYear.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(TpartYear, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel15)
                    .addComponent(TpartYear, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel9)
    ...
    private void jListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jListValueChanged
        PartBean beans = (PartBean)(jList.getSelectedValue());
        if(beans == null)return;

        JComboParts.setSelectedIndex(beans.getPartId()-1);
        TpartYear.setText(""+beans.getPartYear());
    ...
    private javax.swing.JTextField TpartYear;

 ...
 * @author Salman Ahmed
 */
public class SeatListDetailsFrame extends javax.swing.JFrame {

    /**
     * Creates new form SeatListDetailsFrame
     */
    
        
    public SeatListDetailsFrame() {
        initComponents();
        ...
        JComboStatus.addItem("Temporary");
        JComboStatus.addItem("Legal");
    ...
    //////****** getSeatListType Load *******//////
    private void getSeatListType(){
    ...
    //////****** getSeatListDetails Load *******//////
    private void getSeatListDetails(){
            /// Jlist Remove If need to Clear
            ...
            try{
                    Vector v = DatabaseManager.getSeatListDetails(beans.getSeatListId(), beans.getPartId(), beans.getBatchId());
                    jList.setListData(v);
            }catch(Exception ee){
                    ee.printStackTrace();
                    MainWorkPlace.Jpane("Error "+ee);
    ...
    private void paste(){
        ...
        int rows = 0;
        String status = Encode.statusEncode(JComboStatus.getSelectedItem().toString());

        try{
            Vector v = DatabaseManager.getStudentPart(beans.getPartId(), beans.getBatchId());	
            for(int i = 0; i < v.size(); i++){
                StudentPartBean stubeans = (StudentPartBean)v.elementAt(i);
                try{
                    rows += DatabaseManager.addSeatListDetails(beans.getSeatListId(), beans.getPartId(), beans.getBatchId(), stubeans.getStuRollNo(), status, "");
                    if(rows >= 1){
                        clear();
                        getSeatList();
                    }
                }catch(Exception ex){
                    MainWorkPlace.Jpane("Data Already Inserted "+ex.getMessage());
                }
            }

            MainWorkPlace.Jpane(rows+" Student Inserted");

        }catch(Exception ex){
            MainWorkPlace.Jpane("get Student Parts ERROR "+ex.getMessage());
        }
    ...
    private void update(){
            ...
            try{
                for(int i = 0; i < ob.length; i++){
                    SeatListDetailBean beans = (SeatListDetailBean)(ob[i]);
                    rows += DatabaseManager.updateSeatListDetails(beans.getSeatListId(), beans.getPartId(), beans.getBatchId(), beans.getStuRollno(), status, remarks);
                }
    ...
    private void delete(){
        ...
        try{
            for(int i = 0; i < ob.length; i++){
                SeatListDetailBean beans = (SeatListDetailBean)(ob[i]);
                rows += DatabaseManager.deleteSeatListDetails(beans.getSeatListId(), beans.getPartId(), beans.getBatchId(), beans.getStuRollno());
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seat List Details");
        ...
        JComboStatus.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addComponent(update, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(13, 13, 13)
                                .addComponent(TseatListExamType, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap())))
        );
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(paste, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                        .addContainerGap())))
        );
    ...
    private void jListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jListValueChanged
        SeatListDetailBean beans = (SeatListDetailBean)(jList.getSelectedValue());
        if(beans == null)return;

        remarksArea.setText(beans.getRemarks());
        JComboStatus.setSelectedItem(Decode.statusDecode(beans.getStatus()));
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeatListDetailsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

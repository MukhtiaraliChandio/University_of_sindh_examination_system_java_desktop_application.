...
public class SeatListFrame extends javax.swing.JFrame {
    ...
    public SeatListFrame() {
        ...
        JComboExamType.addItem("Regular");
        JComboExamType.addItem("Improver/Failiar");
    ...
    //////****** TbatchShift & TbatchGroup Load *******//////
    private void getShiftGroup(){
            BatchBean beans = (BatchBean)(JComboBatchYear.getSelectedItem());
            if(beans == null)return;

            TbatchShift.setText(beans.getBatchShift());
            TbatchGroup.setText(beans.getBatchGroup());
    }
    //////****** TbatchShift & TbatchGroup Load *******//////
    ...
    private void add(){
        try{
            ...
            int partId = beans.getPartId();


            int seatListYear = Integer.parseInt(TexamYear.getText());

            String seatListType = Encode.typeEncode(JComboExamType.getSelectedItem().toString());

            int row = DatabaseManager.addSeatList(partId, batchId, seatListYear, seatListType, remarks);
    ...
    private void update(){
        try{    
            String remarks = remarksArea.getText();
            int seatListId = Integer.parseInt(TseatListId.getText());
            PartBean beans = (PartBean)(JComboParts.getSelectedItem());
            if(beans == null)return; 
            ...
            int row = DatabaseManager.updateSeatList(seatListId, partId, batchId, seatListYear, seatListType, remarks);
            MainWorkPlace.queryResult(row, "Inserted");
                if(row >= 1){
                    clear();
                    getSeatList();
    ...
    private void delete(){
        try{
            int seatListId = Integer.parseInt(TseatListId.getText());
            int row = DatabaseManager.deleteSeatList(seatListId);	
            ...
            if(row >= 1){
                ...
                ee.printStackTrace();
                MainWorkPlace.Jpane("This Batch has some Students "+ee.getMessage());
        }
    ...
    private void clear(){
            ...
            TseatListId.setText("");
            TexamYear.setText("");
            JComboExamType.setSelectedItem(0);
            remarksArea.setText("");
    }
    ...
    private void initComponents() {
        ...
        JComboExamType = new javax.swing.JComboBox();
        jLabel16 = new javax.swing.JLabel();
        TexamYear = new javax.swing.JTextField();
        ...
        JComboExamType.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
        JComboExamType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JComboExamTypeActionPerformed(evt);
            }
        });
        ...
        TexamYear.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGap(36, 36, 36)
                        .addComponent(add, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(update, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                            ...
                                            .addGap(18, 18, 18)
                                            .addComponent(JComboParts, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(TexamYear, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(jLabel12)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(JComboExamType, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel16)
                    .addComponent(TexamYear, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12)
                    .addComponent(JComboExamType, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel9)
    ...
    private void jListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jListValueChanged
        SeatListBean beans = (SeatListBean)(jList.getSelectedValue());
        if(beans == null)return;

        TseatListId.setText(""+beans.getSeatListId());
        TexamYear.setText(""+beans.getSeatListYear());
        JComboExamType.setSelectedItem(Decode.typeDecode(beans.getSeatListType()));
        remarksArea.setText(beans.getRemarks());

        // TODO add your handling code here:
    }//GEN-LAST:event_jListValueChanged

    private void JComboExamTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JComboExamTypeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JComboExamTypeActionPerformed
    ...
    private javax.swing.JComboBox JComboExamType;
    ...
    private javax.swing.JTextField TexamYear;
